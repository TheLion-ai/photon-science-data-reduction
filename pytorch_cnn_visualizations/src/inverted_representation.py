...
from pytorch_cnn_visualizations.src.misc_functions import get_example_params, recreate_image, save_image
...
class InvertedRepresentation():
    def __init__(self, model):
        self.model = model
        self.model.eval()
        if not os.path.exists('/home/bk/sfx/pytorch-cnn-visualizations/results/generated'):
            os.makedirs('/home/bk/sfx/pytorch-cnn-visualizations/results/generated')
    ...
    def generate_inverted_image_specific_layer(self, input_image, img_size, target_layer=3, file_name_to_export=''):
        ...
        dir = os.path.join('/home/bk/sfx/pytorch-cnn-visualizations/results/generated', file_name_to_export)
        ...
        for i in range(201):
            ...
            if i == 200:
                ...
                # im_path = '/home/bk/sfx/pytorch-cnn-visualizations/results/generated/' + file_name_to_export + '/' + 'Inv_Image_Layer_' + str(target_layer) + \
...
if __name__ == '__main__':
    ...
    (original_images, prep_imgs, target_classes, file_names_to_export, pretrained_model) =\
        get_example_params(target_example)

    inverted_representation = InvertedRepresentation(pretrained_model)
    image_size = 224  # width & height
    target_layer = 4
    for original_image, prep_img, target_class, file_name_to_export in zip(original_images, prep_imgs, target_classes, file_names_to_export):
